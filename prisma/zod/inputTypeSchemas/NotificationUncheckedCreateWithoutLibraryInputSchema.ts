...
export const NotificationUncheckedCreateWithoutLibraryInputSchema: z.ZodType<Prisma.NotificationUncheckedCreateWithoutLibraryInput> = z.object({
...
export default NotificationUncheckedCreateWithoutLibraryInputSchema;
