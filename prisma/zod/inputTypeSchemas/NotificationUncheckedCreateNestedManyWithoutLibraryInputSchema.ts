...
export const NotificationUncheckedCreateNestedManyWithoutLibraryInputSchema: z.ZodType<Prisma.NotificationUncheckedCreateNestedManyWithoutLibraryInput> = z.object({
...
export default NotificationUncheckedCreateNestedManyWithoutLibraryInputSchema;
