...
export const LibraryUncheckedCreateWithoutNotificationsInputSchema: z.ZodType<Prisma.LibraryUncheckedCreateWithoutNotificationsInput> = z.object({
...
export default LibraryUncheckedCreateWithoutNotificationsInputSchema;
